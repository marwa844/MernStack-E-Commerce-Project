    ...
    const addToCart = async( productId:string ) => {
      ...
      // Add items to cart 
          ...
          try {
              ...
              const cartItemsMapped = cart.items.map(({product, quantity}:{product:any, quantity:number})=>({ productId : product._id, title: product.title, image: product.image, onsale: product.onsale, quantity : product.quantity}))
